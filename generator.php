...
class MemeGenerator{
	...
	public function __construct($path)
	{
		...
		$this->foreground = imagecolorallocate($this->im, 255, 255, 255);
		imagecolortransparent($this->im, $this->foreground);
		$this->background = imagecolorallocate($this->im, 0, 0, 0);
	...
	{
		imagettftext($this->im,$fontsize,0,$Xlocation + 1,$Textheight, (int)$this->background, $font, $text);		
		imagettftext($this->im,$fontsize,0,$Xlocation - 1,$Textheight, (int)$this->background, $font, $text);		
		imagettftext($this->im,$fontsize,0,$Xlocation,$Textheight, (int)$this->foreground, $font, $text);		
	}
...
$obj = new MemeGenerator($_GET['src']);
$upmsg   = $_GET['upmsg'];
